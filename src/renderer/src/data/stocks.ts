export const stocks = [
  ...
  // Few stocks traded in Hong Kong Stock ExchangeId
  {
    ...
    description:
      'Tencent Holdings Limited, an investment holding company, provides value-added services (VAS) and online advertising services in Mainland China, the United States, Europe, and internationally.',
    country: 'Hong Kong',
  ...
  },
  {
    ...
    description:
      'China Mobile Limited, an investment holding company, provides mobile telecommunications and related services in Mainland China and Hong Kong.',
    country: 'Hong Kong',
  ...
  },
  {
    ...
    description:
      'AIA Group Limited provides insurance products and services in Asia, the Pacific, and the Americas.',
    country: 'Hong Kong',
